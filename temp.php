...
class mailTemp{
    ...
    /**
     * @param string $title_two
     */
    public function setTitleTwo($title_two)
    {
    ...
    {
        if(empty($this->img)){
            $this->img = "https://mobzeta.com/zsp/images/zeta/zeta-profile-small.jpg";
        }
        if(empty($this->staff_title)){
            $this->staff_title = "CEO / Founder";
        }
        if(empty($this->staff)){
            $this->staff = "Revelation A.F";
        }
    }
...
<head>
    ...
    <link href="https://mobzeta.com/zsp/css/zeta/zeta-global.css"/>
    <title>MobZeta Network</title>
</head>
                            ...
                            <tr>
                                <td valign="top" class="bodyContentImageFull" mc:edit="body_content_01">
                                    <p style="text-align:center;margin:0;padding:0;">
                                        <img src="https://mobzeta.com/zsp/images/zeta/zeta-mail-header.jpg" style="display:block;" />
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                    <h3>'.$this->title.'</h3>
                                    <h2><strong>'.$this->title_two.'</strong></h2>
                                    <p>'.$this->body.'</p>
                                </td>
                            </tr>
                        </table>
                                        ...
                                        <tr>
                                            <td align="left" width="50" valign="top" mc:edit="footer_sigimage" style="margin:0;padding:0;">
                                                <p style="margin-bottom:10px"padding:0;display:block;>
                                                    <img src="'.$this->img.'" style="display:block;" />
                                                </p>
                                            </td>
                                            ...
                                            <td align="left" valign="top" mc:edit="footer_sig" valign="top" style="margin:0;padding-top:10px;line-height:1;">
                                                <h4><strong>'.$this->staff.'</strong></h4>
                                                <h5>'.$this->staff_title.'</h5>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                            <tr>
                                <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                    <h6 style="text-align:center;margin-top: 9px;">MobZeta Network</h6>
                                    <h6 style="text-align:center;">Abuja, Nig.</h6>
